# Design Language: Clearscope | Get Discovered on Google & AI Search

> Extracted from `https://clearscope.io` on April 16, 2026
> 353 elements analyzed
...
| Hex | HSL | Usage Count |
|-----|-----|-------------|
| `#000000` | hsl(0, 0%, 0%) | 547 |
| `#f4f4f2` | hsl(60, 8%, 95%) | 140 |
...
| Hex | Contexts | Count |
|-----|----------|-------|
| `#000000` | text, border, background | 547 |
| `#f4f4f2` | background, text, border | 140 |
...
- **GT-Pressura-Mono** — used for all (329 elements)
...
| 36.2448px | 2.2653rem | 600 | 43.4938px | normal | h2 |
| 30.312px | 1.8945rem | 600 | 36.3744px | normal | h2 |
| 21.217px | 1.3261rem | 400 | 31.8254px | normal | p, a |
...
| 14.865px | 0.9291rem | 500 | 14.865px | normal | svg, polyline, a, p |
...
h2 { font-size: 36.2448px; font-weight: 600; line-height: 43.4938px; }
h2 { font-size: 30.312px; font-weight: 600; line-height: 36.3744px; }
...
**9 grid containers** and **63 flex containers** detected.
...
gap: 62.7814px;
grid-template-columns: 570.156px 570.156px;
gap: 38.4563px 62.7814px;
grid-template-columns: 570.156px 570.156px;
gap: 38.4563px 62.7814px;
grid-template-columns: 570.156px 570.156px;
gap: 38.4563px 62.7814px;
...
**Gap values:** `115.939px`, `15.8368px`, `155.533px`, `16px`, `1px`, `23.1882px`, `23.7565px`, `2px`, `38.4563px 62.7814px`, `4px`, `54.2944px`, `55.4314px`, `55.4314px normal`, `62.7814px`, `7.9184px`, `78.0496px`, `79.1882px`, `8px`
...
|----------|-----------|-------------|-------------|-----------|-------------|
| mobile (375px) | 16px | No | 2 | No | 11389px |
| tablet (768px) | 16px | No | 3 | No | 10741px |
| desktop (1280px) | 16px | Yes | 5 | No | 7932px |
| wide (1920px) | 16px | Yes | 5 | No | 8191px |
...
**Overall Score: 100%** — 16 passing, 0 failing color pairs
...
**Strengths:** Tight, disciplined color palette, Consistent typography system, Consistent border radii, Strong accessibility compliance, Good CSS variable tokenization
...
|---------|-------|------------|
| thumbnail | 25 | objectFit: fill, borderRadius: 0px, shape: square |
| general | 9 | objectFit: cover, borderRadius: 0px, shape: square |
| gallery | 4 | objectFit: fill, borderRadius: 0px, shape: square |

**Aspect ratios:** 3:2 (8x), 4:3 (5x), 1:1 (5x), 4.13:1 (4x), 2.67:1 (3x), 4.77:1 (2x), 6.77:1 (2x), 3.5:1 (2x)
